...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/destraadryann/Yanstring)
...
1. Clone the repo
   ```markdown
   git clone https://github.com/destraadryann/Yanstring
   ```
...
Group Chat :- [Group support](https://t.me/yanzzxsupport)
